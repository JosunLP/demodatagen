...
const LOREM_WORDS: &[&str] = &[
    ...
    "similique", "mollitia", "animi", "sapiente", "totam", "rem", "aperiam",
    "inventore", "veritatis", "quasi", "architecto", "beatae", "vitae", "dicta",
    "explicabo", "nemo", "ipsam", "voluptatem", "quia", "voluptas", "aspernatur",
    "aut", "odit", "fugit", "consequuntur", "magni", "dolorem", "porro",
...
const HEADING_WORDS: &[&str] = &[
    "Introduction", "Overview", "Getting", "Started", "Configuration", "Setup",
    "Installation", "Usage", "Examples", "Advanced", "Topics", "Performance",
    "Security", "Testing", "Deployment", "Architecture", "Design", "Patterns",
    "Best", "Practices", "Troubleshooting", "FAQ", "Reference", "API",
    "Documentation", "Guide", "Tutorial", "Quick", "Start", "Deep", "Dive",
    "Analysis", "Summary", "Conclusion", "Results", "Methodology", "Background",
    "Discussion", "Implementation", "Optimization", "Evaluation", "Comparison",
];
...
mod tests {
    ...
    fn test_heading_non_empty() {
        ...
        assert!(word_count >= 2 && word_count <= 4);
    }
